...
export class RegularForm extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      binder: new FormBinder(
        obj,
        RegularForm.bindings,
        this.props.onAnyModified
      ),
    }
  }
  ...
  handleSubmit(e) {
    ...
    let obj = this.state.binder.getDeltaObject()
  ...
  handleReset() {
    ...
    this.setState({
      binder: new FormBinder(
        this.state.binder.getOriginalObject(),
        RegularForm.bindings,
        onAnyModified
      ),
    })
          ...
          <Grid.Column width={16}>
            <Form.Group>
              <BoundDropdown
                ...
                label={"Access Level"}
                width={6}
                options={RegularForm.accessLevels}
                name="role"
                message="The user role and security level"
            ...
            <Form.Group>
              <BoundCheckbox
                ...
                name="admin"
                binder={this.state.binder}
                message="Is this user an administrator?"
              />
            </Form.Group>
            ...
            <Form.Group>
              <BoundInput
                ...
                width={4}
                name="zip"
                message="5 Character U.S. Zip Code. Optional."
                position="top center"
                binder={this.state.binder}
              />
            </Form.Group>
            ...
            <Form.Group>
              <BoundDropdown
                ...
                name="state"
                width={4}
                message="Select a U.S. state"
                placeholder="Select State"
                options={RegularForm.stateOptions}
                binder={this.state.binder}
              />
            </Form.Group>
            ...
            <Form.Group>
              <BoundInput
                ...
                name="address"
                binder={this.state.binder}
                message="Primary Street Address. Optional."
              />
            </Form.Group>
            ...
            <Form.Group>
              <BoundMaskedInput
                ...
                mask="(999) 999 9999"
                binder={this.state.binder}
                message="A valid U.S. phone number. Optional."
              />
            </Form.Group>
            ...
            <Form.Group>
              <BoundCreditCardInput
                ...
                name="cardNumber"
                binder={this.state.binder}
                message="A credit credit card number"
              />
              <BoundMaskedInput
                label="Expiration"
                width={3}
                ...
                mask="99/99"
                binder={this.state.binder}
                message="A credit card expiration."
              />
              <BoundMaskedInput
                label="CVC"
                width={3}
                ...
                mask="9999"
                binder={this.state.binder}
                message="A credit card CVC/CVV number."
              />
            </Form.Group>
            ...
            <Form.Group>
              <BoundMaskedInput
                ...
                mask="999-99-9999"
                binder={this.state.binder}
                message="U.S. Social Security Number, e.g. 123-45-6789"
              />
            </Form.Group>
            ...
            <BoundContainer
              ...
              <Form.Group>
                <BoundInput
                  label="Magic Admin Field"
                  width={8}
                  name="magic"
                  message="A magical spell."
                  binder={this.state.binder}
                />
              </Form.Group>
            </BoundContainer>
            ...
            <Form.Group>
              ...
              <BoundButton
                ...
                width={4}
                size="medium"
                content={this.state.binder._id ? "Save" : "Add"}
                label="&nbsp;"
                name="submit"
                binder={this.state.binder}
              />
